...
.
- Generate the
[API Keys](https://razorpay.com/docs/payments/dashboard/account-settings/api-keys/#generate-api-keys)
...
- Know about the
[Payment Flow](https://razorpay.com/docs/payments/payment-gateway/how-it-works/)
  ...
  <script>
    ...
    async function payNow() {
      ...
      const response = await fetch('/create-order', {
        ...
        body: JSON.stringify({ amount, currency: 'USD', receipt: 'receipt#1', notes: {} })
...
[payment products](https://razorpay.com/docs/payments/)
